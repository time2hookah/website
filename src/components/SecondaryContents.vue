  ...
  >
    <div class="u-sidebar__scroller">
      <div class="u-sidebar__container">
            ...
            <div class="u-sidebar__content u-header-sidebar__content">
              <form class="js-validate">
                ...
                >
                  ...
                  <div class="form-group">
                    <div class="js-form-message js-focus-state">
                      <label class="sr-only" for="signupPassword"
                        >Password</label
                      >
                      <div class="input-group">
                        <div class="input-group-prepend">
        ...
        <footer
          id="SVGwaveWithDots"
          class="svg-preloader u-sidebar__footer u-sidebar__footer--account"
        >
          <ul class="list-inline mb-0">
            <li class="list-inline-item pr-3">
              <a
                class="u-sidebar__footer--account__text"
                href="html/pages/privacy.html"
                >Privacy</a
              >
            </li>
            <li class="list-inline-item pr-3">
          ...
          <div class="position-absolute right-0 bottom-0 left-0">
            <img
              ...
              src="/template/assets/svg/components/wave-bottom-with-dots.svg"
