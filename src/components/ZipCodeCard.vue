<template>
  ...
  <div id="zipCodecard" class="container-fluid" style='background-image:url("assets/img/shisha/background2.jpg"); background-size: cover; width: 100%; height: 100%; '>
      <!-- Content -->
...
export default {
  ...
  mounted() {
    ...
    $("#zipCodecard").css("background-size", "cover");
    $("#zipCodecard").css("background-position", "50% 0");
  },
  destroyed() {
    // $("#zipCodecard").css("background-image", "");
    $("#zipCodecard").css("background-size", "");
    $("#zipCodecard").css("background-position", "initial");
  },
  methods: {
    onZipChange(e) {
      var zipCodes = [
